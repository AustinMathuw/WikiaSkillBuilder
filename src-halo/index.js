...
var wiki = new Wikia("halo"); //Define wikia site (subdomain)
...
var languageStrings = {
    "en": {
        "translation": {
            ...
            "SKILL_NAME": "Unofficial Halo Wiki",
            "WELCOME_MESSAGE": "Welcome to %s. You can ask a question like, what is the spartan program? ... Now, what can I help you with.",
            "WELCOME_REPROMPT": "For instructions on what you can say, please say help me.",
            "DISPLAY_CARD_TITLE": "%s",
            "HELP_MESSAGE": "You can ask questions such as, what is the spartan program, or, you can say exit...Now, what can I help you with?",
            "HELP_REPROMPT": "You can say things like, what is the spartan program, or you can say exit...Now, what can I help you with?",
    ...
    "en-US": {
        "translation": {
            "ARTICLES" : articleIds,
            "SKILL_NAME" : "Unofficial Halo Wiki: US Version"
        }
    },
    "en-GB": {
        "translation": {
            "ARTICLES": articleIds,
            "SKILL_NAME": "Unofficial Halo Wiki: UK Version"
        }
    }
};
        ...
        .then(function(data) {
            ...
            for(var section in article.sections){
                ...
                if(typeof article.sections[section].images[0] != "undefined") {
                    imageSrc = article.sections[section].images[0].src.replace(".net",".net.rsz.io");
                }
...
function speechBuilder(contextThis, sectionCurrent, sectionCurrentContent, sectionsWithContent, isStart){
    ...
    /*if(sectionsWithContent[sectionCurrent].image != null){
        if(sectionsWithContent[sectionCurrent].image.indexOf(".png") > -1){
            var imageObj = {
                smallImageUrl: sectionsWithContent[sectionCurrent].image.substring(0, sectionsWithContent[sectionCurrent].image.indexOf(".png")+4)+"?height=480?width=720",
                largeImageUrl: sectionsWithContent[sectionCurrent].image.substring(0, sectionsWithContent[sectionCurrent].image.indexOf(".png")+4)+"?height=800?width=1200"
            };
